...
<head>
    ...
    <title>Edit Karyawan | PT Sampoerna Mild</title>
    <!-- CSS only -->
...
<body>
    ...
    <div class="container">
        ...
        <!-- add/edit form modal -->
        <center>
            <h5 class="modal-title" id="exampleModalLabel">Edit Data karyawan <i class="fa fa-user-circle-o" aria-hidden="true"></i></h5>
        </center>

        <form id="addform" method="POST" action="config/proses_edit.php">
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" id="username" name="nama" value="<?php echo $nama; ?>" required="required">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" id="email" name="jabatan" value="<?php echo $jabatan; ?>" required="required">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="phone" class="form-control" id="phone" name="alamat" value="<?php echo $alamat; ?>" required="required">
                    </div>
                </div>
