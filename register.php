...
<head>
    ...
    <title>Register | PT Sampoerna Mild</title>
...
<body style="background-color: #141f1f">
    ...
    <div class="container">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block" style="background-image: url(image/portfolio/2.png);"></div>
                    <div class="col-lg-7">
                        <div class="p-5">
    ...
    <footer>
        <div class="container text-center">
            <div class="row">
                <div class="col-sm-12">
                    <p style="background-color: white;">&copy; Copyright by 18111063_HIJAJ LA BAIKA_TIF RP 18 CID A</p>
                </div>
            </div>
        </div>
    </footer>
